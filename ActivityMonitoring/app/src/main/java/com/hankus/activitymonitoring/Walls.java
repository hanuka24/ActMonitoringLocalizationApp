...
public class Walls {
    ...
    public Walls()
    {
        ...
        Line Wall9 = new Line( new Point(438, 66), new Point( 418, 24));
        Line Wall10 = new Line( new Point(438, 24), new Point( 438, 159));
        Line Wall11 = new Line( new Point(419, 159), new Point( 438, 159));
        Line Wall12 = new Line( new Point(419, 159), new Point( 419, 117));
        ...
        Line Wall20 = new Line( new Point(2, 159), new Point( 437, 159));
